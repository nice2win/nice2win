...
// * nice2win - fair games that pay Ether. Version 1.
//
// * Matic smart contract, deployed at 0xB0450Ff766c81222D29f7E61ff47b5D0e43d78F2.
//
...
contract N2W {
    ...
    uint256 constant HOUSE_EDGE_MINIMUM_AMOUNT = 0.1 ether;

    // Bets lower than this amount do not participate in jackpot rolls (and are
    // not deducted JACKPOT_FEE).
    uint256 constant MIN_JACKPOT_BET = 30 ether;

    // Chance to win jackpot (currently 0.1%) and fee deducted into jackpot fund.
    uint256 constant JACKPOT_MODULO = 1000;
    uint256 constant JACKPOT_FEE = 0.3 ether;
    ...
    // threshold. On rare occasions nice2win croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of nice2win operation.
    ...
    //                    by the nice2win croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the nice2win support, however nothing
