...
contract Nice2Win {
    ...
    uint256 public houseEdgeMinimumAmount = 0.0001 ether;
    uint256 public minJackpotBet = 0.03 ether;
    uint256 public jackpotModulo = 1000;
    uint256 public jackpotFee = 0.0003 ether;
    ...
    function setHouseEdgePercent(uint256 _houseEdgePercent) public onlyOwner {
        houseEdgePercent = _houseEdgePercent;
    }

    function setHouseEdgeMinimumAmount(uint256 _houseEdgeMinimumAmount)
        public
        onlyOwner
    {
    ...
    function setMinJackpotBet(uint256 _minJackpotBet) public onlyOwner {
        minJackpotBet = _minJackpotBet;
    }

    function setJackpotModulo(uint256 _jackpotModulo) public onlyOwner {
        jackpotModulo = _jackpotModulo;
    }

    function setJackpotFee(uint256 _jackpotFee) public onlyOwner {
